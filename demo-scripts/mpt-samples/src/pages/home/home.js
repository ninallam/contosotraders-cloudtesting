...
const Home = ({ recommendedProducts, popularProducts, loggedIn }) => {
    ...
    return (
        <div className="home">
            ...
            {/* <Banner firstHeading="Xbox Wireless Controller – Mineral Camo limited editin" secondHeading="Textured triggers and bumpers | Hybrid D-pad | Button mapping | Bluetooth® technology"/> */}
            <Gridsection />
            <Finalsection />
